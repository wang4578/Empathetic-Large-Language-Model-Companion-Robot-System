...
#output_dir='../exp/ltuas_ft_iemocap_4/'
output_dir='../exp/ltuas_ft_meld/'
mkdir -p $output_dir
cp "$0" ${output_dir}/$(date +"%Y-%m-%d-%H-%M-%S").sh

python ../finetune_low_resource.py \
    --base_model '/root/ltu-main/ltu-main/src/ltu_as/exp/ltuas_ft_iemocap_4/checkpoint-24/pytorch_model.bin' \
    --data_path '/root/ltu-main/ltu-main/openasqa/data/meld_data_filtered.json'\
